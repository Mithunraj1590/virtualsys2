                    ...
                    <div className="col-lg-12">
                        <div className="section-title text-center">
                            <SectionTitle
                                    ...
                                    Title="Complete Solutions for Your<br> Digital <span>Transformation</span>"
                            ></SectionTitle>
                            <p className="section-title-descr" style={{maxWidth: '800px', margin: '20px auto 0'}}>
                                At Virtual Sys Technologies, our services are designed to meet your needs — whether you require a single developer or an entire offshore product team. We combine IT staffing, product design, and managed delivery to create end-to-end solutions that reduce costs and maximize output.
                            </p>
                        </div>
                    </div>
                    {data.map((item, i) => (
                    <div key={i} className="col-lg-4 col-md-6 col-sm-12" style={{marginBottom: '30px'}}>
